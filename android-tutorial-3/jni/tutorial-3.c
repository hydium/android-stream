...
//    4194304
  data->pipeline =
      gst_parse_launch ("udpsrc port=10000 buffer-size=2000000 ! application/x-rtp, media=\"video\", clock-rate=90000, encoding-name=\"JPEG\" ! rtpjpegdepay  ! jpegdec !  autovideosink",
      &error);

//    data->pipeline =
//         gst_parse_launch ("udpsrc port=10000 ! application/x-rtp, "
//                           "media=\"video\", clock-rate=90000, encoding-name=\"H264\" ! rtph264depay ! avdec_h264 ! autovideosink",
//                           &error);
